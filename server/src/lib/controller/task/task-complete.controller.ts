...
export class TaskCompleteController implements RouteController {
...
export const taskCompleteController: RouteController = new TaskCompleteController(_taskService)
